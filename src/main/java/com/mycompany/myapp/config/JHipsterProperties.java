...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "proyecto2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "proyecto2 API";

        private String description = "proyecto2 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "proyecto2";
